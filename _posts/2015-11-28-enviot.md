...
Since I know the Arduino can successfully read data from all the modules in its current connected state I will move onto designing the software. Since the Arduino has limited resources I'll be looking at designing the software to send from the Arduino to a web server.
